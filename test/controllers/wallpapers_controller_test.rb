...
class WallpapersControllerTest < ActionController::TestCase
  ...
  test "should create wallpaper" do
    assert_difference('Wallpaper.count') do
      post :create, wallpaper: { cat: @wallpaper.cat, color: @wallpaper.color, picture_id: @wallpaper.picture_id, title: @wallpaper.title }
    end
  ...
  test "should update wallpaper" do
    patch :update, id: @wallpaper, wallpaper: { cat: @wallpaper.cat, color: @wallpaper.color, picture_id: @wallpaper.picture_id, title: @wallpaper.title }
    assert_redirected_to wallpaper_path(assigns(:wallpaper))
  end
